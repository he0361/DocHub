  ...
  <section class="admin-shell">
    <aside class="admin-sidebar" :class="{ 'admin-sidebar-open': sidebarOpen }">
      <div class="sidebar-brand">
        <img class="brand-mark" src="/logo.png" alt="文枢 DocHub" />
        <strong class="brand-name">文枢 DocHub</strong>
      </div>
      ...
      <div class="sidebar-footer">
        <div class="sidebar-user-card">
          <div class="sidebar-user-info">
            <img class="sidebar-avatar" src="/logo.png" alt="avatar" />
            <div>
      ...
      <header class="admin-header">
        ...
        <div class="header-actions">
          ...
          <div class="header-user">
            <span>{{ username }}</span>
            <img class="header-avatar" src="/logo.png" alt="avatar" />
          </div>
        </div>
      </header>
...
const navItems = [
  { to: '/admin/dashboard', label: '运营总览', icon: HomeModernIcon, permission: 'dashboard' },
  { to: '/admin/documents', label: '文档接入', icon: ClipboardDocumentListIcon, permission: 'document_manage' },
