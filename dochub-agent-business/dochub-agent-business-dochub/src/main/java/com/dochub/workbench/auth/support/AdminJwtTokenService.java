...
import com.dochub.workbench.auth.config.AdminAuthProperties;
...
public class AdminJwtTokenService {
    ...
    public Claims parseToken(String token) {
        try {
            ...
            throw new DochubFrameException(401, "后台登录已过期，请重新登录", exception);
        } catch (JwtException | IllegalArgumentException exception) {
            throw new DochubFrameException(401, "后台登录无效，请重新登录", exception);
        }
    }
}
