...
import com.dochub.workbench.chatagent.rag.service.GraphAnswerRenderer;
import com.dochub.workbench.chatagent.rag.service.StructureGraphQueryEngine;
...
import com.dochub.workbench.manage.model.graph.GraphQueryResult;
import com.dochub.workbench.manage.model.graph.GraphSectionWithChildren;
import com.dochub.workbench.manage.model.graph.GraphSectionWithSiblings;
...
public class GraphOnlyExecutor implements ConversationExecutor {
    ...
    public Flux<String> execute(TaskInfo taskInfo) {
        ...
        if (decision.getNavigationAction() == com.dochub.workbench.chatagent.rag.model.DocumentNavigationAction.SECTION_ADJACENCY_LOOKUP) {
