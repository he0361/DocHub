...
import com.dochub.workbench.auth.config.PreviewModeProperties;
...
public class PreviewModeInterceptor implements HandlerInterceptor {
    ...
    private static final Set<String> BLOCKED_PATHS = Set.of(
        ...
        "/manage/workbench/template/save",
        "/manage/workbench/template/delete",
        "/manage/workbench/docgen/generate",
        "/manage/workbench/docgen/ingest",
        "/manage/workbench/skill/market/install",
        "/manage/workbench/skill/installed/enable",
        "/manage/workbench/skill/installed/disable",
        "/manage/workbench/skill/installed/delete"
    );
