...
import com.dochub.workbench.manage.model.es.DocumentNavigationIndexRecord;
...
public class ElasticsearchDocumentNavigationIndexService implements DocumentNavigationIndexService {
    ...
    @Override
    public void reindexDocumentNodes(Long documentId, Long parseTaskId, List<DochubDocumentStructureNode> nodes) {
        if (documentId == null) {
            return;
        }
    ...
    private DocumentNavigationIndexRecord toIndexRecord(DochubDocumentStructureNode node, Long parseTaskId) {
