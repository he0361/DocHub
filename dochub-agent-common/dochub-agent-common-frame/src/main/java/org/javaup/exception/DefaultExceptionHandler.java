...
public class DefaultExceptionHandler {
    ...
    @ExceptionHandler(value = DochubFrameException.class)
    public ApiResponse<String> toolkitExceptionHandler(HttpServletRequest request, DochubFrameException dochubFrameException) {
        log.error("业务异常 错误信息 : {} method : {} url : {} query : {} ", dochubFrameException.getMessage(), request.getMethod(), getRequestUrl(request), getRequestQuery(request), dochubFrameException);
        return ApiResponse.error(dochubFrameException.getCode(), dochubFrameException.getMessage());
    }
