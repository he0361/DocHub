/*
  ...
  注意：
  - 本脚本会更新 dochub_document 的知识域编码、名称、业务分类和标签。
...
INSERT INTO dochub_knowledge_scope_node (
...
INSERT INTO dochub_knowledge_topic_node (
...
INSERT INTO dochub_document_profile (
...
UPDATE dochub_topic_document_relation
...
INSERT INTO dochub_topic_document_relation (
...
SELECT
    ...
    r.reason,
    r.status
FROM dochub_topic_document_relation r
LEFT JOIN dochub_knowledge_topic_node t ON t.topic_code = r.topic_code
LEFT JOIN dochub_document d ON d.id = r.document_id
